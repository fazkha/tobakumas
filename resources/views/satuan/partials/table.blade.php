            ...
            <tbody>
                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->nama_lengkap }}</span>
                        </td>
                        <td
                            class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->singkatan }}</span>
                        </td>
                        <td
                            class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                        ...
                        <td class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800"
                            ...
                            <div class="flex items-center justify-center">
                                @can('satuan-show')
                                    <a href="{{ route('units.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('satuan-edit')
                                    <a href="{{ route('units.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('satuan-delete')
                                    <a href="{{ route('units.delete', Crypt::Encrypt($data->id)) }}"
