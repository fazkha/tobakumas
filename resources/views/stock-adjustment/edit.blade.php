    ...
    <div x-data="{
        ...
        <div class="w-full px-4 py-2">
            <div class="flex flex-col items-center">
                ...
                <form id="master-form" action="{{ route('stock-adjustment.update', Crypt::Encrypt($datas->id)) }}"
                            ...
                            <div class="flex flex-col lg:flex-row">
                                <div class="w-full lg:w-1/2 px-2">
                                    ...
                                    <div class="w-auto pb-4">
                                        ...
                                        <x-input-error class="mt-2" :messages="$errors->get('tanggal_adjustment')" />
                                    </div>
                                    ...
                                    <div class="w-auto pb-4">
                                        ...
                                        <x-input-error class="mt-2" :messages="$errors->get('keterangan_adjustment')" />
                                    </div>
                                </div>
                                ...
                                <div class="w-full lg:w-1/2 px-2 flex flex-col justify-start">
                                    ...
                                    <div class="flex flex-row flex-wrap items-center justify-end gap-2 md:gap-4">
                                        ...
                                        <x-anchor-secondary href="{{ route('stock-adjustment.index') }}"
                                            tabindex="8">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                class="size-5">
        ...
        <script type="text/javascript">
            $(document).ready(function(e) {
                ...
                $("#submit-detail").on("click", function(e) {
                    ...
                    $.ajax({
                        url: '{{ url('/warehouse/stock-adjustment/update-detail') }}' + '/' + key,
                        type: 'post',
                        dataType: 'json',
