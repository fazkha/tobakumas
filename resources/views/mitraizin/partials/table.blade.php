                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span
                                class="{{ $data->approved_hrd == 1 ? 'text-blue-600' : ($data->approved_hrd == 2 ? 'text-red-600' : 'text-gray-900') }} dark:text-white">{{ $data->approved_hrd == 1 ? '✔️' . __('messages.approved') : ($data->approved_hrd == 2 ? '❌' . __('messages.notapproved') : '⏳' . __('messages.pending')) }}</span>
                        </td>
