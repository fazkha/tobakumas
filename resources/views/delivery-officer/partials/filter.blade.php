                ...
                <div class="flex-row justify-start">
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="pp-dropdown"
                            ...
                            <option
                                {{ session('delivery-officer_pp') == config('custom.list_per_page_opt_2') ? 'selected' : '' }}
                                value="{{ config('custom.list_per_page_opt_2') }}">
                                {{ config('custom.list_per_page_opt_2') }}</option>
                            <option
                                {{ session('delivery-officer_pp') == config('custom.list_per_page_opt_3') ? 'selected' : '' }}
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="isdone-dropdown"
                            ...
                            <option {{ session('delivery-officer_isdone') == '0' ? 'selected' : '' }} value="0">
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="propinsi-dropdown"
                            ...
                            @foreach ($propinsis as $id => $name)
                                <option {{ session('delivery-officer_propinsi_id') == $id ? 'selected' : '' }}
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="kabupaten-dropdown"
                            ...
                            @foreach ($kabupatens as $id => $name)
                                <option {{ session('delivery-officer_kabupaten_id') == $id ? 'selected' : '' }}
                                    value="{{ $id }}">{{ $name }}</option>
                            @endforeach
                        </select>
                        <div
            ...
            <div class="flex flex-row flex-wrap gap-2">
                ...
                @can('delivery-show')
                    <x-secondary-button id="print-rekap"
                        ...
                        <span class="pl-1">@lang('messages.deliveryreport')</span>
                    </x-secondary-button>
                @endcan
            </div>
                            ...
                            <div class="relative shadow-md mr-2 mb-2">
                                ...
                                <select id="bulan-dropdown"
                                    ...
                                    @foreach ($bulans as $id => $name)
                                        <option {{ session('delivery-officer_periode_bulan') == $id ? 'selected' : '' }}
                                            value="{{ $id }}">{{ $name }}</option>
                                    @endforeach
                                </select>
                                <div
