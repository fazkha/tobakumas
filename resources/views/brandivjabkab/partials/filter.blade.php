                ...
                <div class="flex-row justify-start">
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="pp-dropdown"
                            ...
                            <option {{ session('brandivjabkab_pp') == 15 ? 'selected' : '' }} value="15">15</option>
                            <option {{ session('brandivjabkab_pp') == 30 ? 'selected' : '' }} value="30">30</option>
                            <option {{ session('brandivjabkab_pp') == 45 ? 'selected' : '' }} value="45">45</option>
                        </select>
                        <div
