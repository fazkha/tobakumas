                    ...
                    <tr>
                        ...
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800"
                            ...
                            <div class="flex items-center justify-center">
                                @can('kritiksaran-show')
                                    <a href="{{ route('criticism.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('kritiksaran-edit')
                                    <a href="{{ route('criticism.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('kritiksaran-delete')
                                    <a href="{{ route('criticism.delete', Crypt::Encrypt($data->id)) }}"
