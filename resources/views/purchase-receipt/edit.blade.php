    ...
    <div class="py-2 flex flex-col">
        ...
        <div class="w-full px-4 py-2">
            <div class="flex flex-col items-center">
                ...
                <form id="master-form" action="{{ route('purchase-receipt.update', Crypt::Encrypt($datas->id)) }}"
                            ...
                            <div class="flex flex-col lg:flex-row">
                                ...
                                <div class="w-full lg:w-1/2 px-2 flex flex-col justify-start">
                                    ...
                                    <div class="w-auto pb-4 lg:pb-12">
                                        ...
                                        <x-input-error class="mt-2" :messages="$errors->get('keterangan_terima')" />
                                    </div>
                                    ...
                                    <div class="flex flex-row flex-wrap items-center justify-end gap-2 md:gap-4">
                                        ...
                                        <x-anchor-secondary href="{{ route('purchase-receipt.index') }}"
                                            tabindex="5">
        ...
        <script type="text/javascript">
            $(document).ready(function(e) {
                ...
                $("#submit-detail").on("click", function(e) {
                    ...
                    $.ajax({
                        url: '{{ url('/warehouse/purchase-receipt/update-detail') }}' + '/' + key,
                        type: 'post',
                        dataType: 'json',
