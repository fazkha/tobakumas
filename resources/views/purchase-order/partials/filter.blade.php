<div class="my-2">
    <div class="flex flex-col-reverse md:flex-row gap-4 justify-between">
                ...
                <div class="flex-row justify-start">
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="pp-dropdown"
                            ...
                            <option {{ session('purchase-order_pp') == 5 ? 'selected' : '' }} value="5">5</option>
                            <option {{ session('purchase-order_pp') == 10 ? 'selected' : '' }} value="10">10
                            </option>
                            <option {{ session('purchase-order_pp') == 20 ? 'selected' : '' }} value="20">20
                            </option>
                        </select>
                        <div
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="isactive-dropdown"
                            class="text-sm px-2 leading-tight pl-28 pr-9 py-2 appearance-none w-full h-full rounded-md border block bg-primary-20 border-primary-100 text-gray-700 dark:text-white dark:bg-primary-700 dark:border-primary-800">
                            <option {{ session('purchase-order_isactive') == 'all' ? 'selected' : '' }} value="all">
                                @lang('messages.all')</option>
                            <option {{ session('purchase-order_isactive') == '1' ? 'selected' : '' }} value="1">
                                @lang('messages.yes')</option>
                            <option {{ session('purchase-order_isactive') == '0' ? 'selected' : '' }} value="0">
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="tunai-dropdown"
                            class="text-sm px-2 leading-tight pl-28 pr-9 py-2 appearance-none w-full h-full rounded-md border block bg-primary-20 border-primary-100 text-gray-700 dark:text-white dark:bg-primary-700 dark:border-primary-800">
                            <option {{ session('purchase-order_tunai') == 'all' ? 'selected' : '' }} value="all">
                                @lang('messages.all')</option>
                            <option {{ session('purchase-order_tunai') == '1' ? 'selected' : '' }} value="1">
                                @lang('messages.cash')</option>
                            <option {{ session('purchase-order_tunai') == '2' ? 'selected' : '' }} value="2">
                ...
                <div class="flex-row justify-start">
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="supplier-dropdown"
                            class="text-sm px-2 leading-tight pl-28 pr-9 py-2 appearance-none w-full h-full rounded-md border block bg-primary-20 border-primary-100 text-gray-700 dark:text-white dark:bg-primary-700 dark:border-primary-800">
                            <option {{ session('purchase-order_supplier_id') == 'all' ? 'selected' : '' }}
                                value="all">
                                @lang('messages.all')
                            </option>
                            @foreach ($suppliers as $id => $name)
                                <option {{ session('purchase-order_supplier_id') == $id ? 'selected' : '' }}
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <input id="search-no_order" placeholder="@lang('messages.search')"
                            value="{{ session('purchase-order_no_order') == '_' ? '' : session('purchase-order_no_order') }}"
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        <span
                            class="w-24 text-xs h-full absolute inset-y-0 left-0 flex items-center px-2 border-r border-primary-100 dark:border-primary-800">@lang('messages.date')</span>
                        <input id="search-tanggal" type="date" placeholder="@lang('messages.search')"
                            value="{{ session('purchase-order_tanggal') == '_' ? '' : session('purchase-order_tanggal') }}"
                            class="text-sm pl-28 pr-6 pt-1.5 pb-2 appearance-none rounded-md border block w-full bg-primary-20 border-primary-100 placeholder-gray-400 text-gray-700 dark:text-white dark:bg-primary-700 dark:border-primary-800" />
                    </div>
                </div>
            </div>
        ...
        <div>
            @can('po-create')
                <x-anchor-primary href="{{ route('purchase-order.create') }}">
