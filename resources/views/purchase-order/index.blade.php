    ...
    <div class="mx-auto px-4 py-2">
        <div class="flex flex-col items-center">
            ...
            <div id="table-container" class="w-full">
                @include('purchase-order.partials.table')
            </div>
            ...
            $("#pp-dropdown, #isactive-dropdown, #tunai-dropdown, #supplier-dropdown, #search-no_order, #search-tanggal")
                .on(
                    ...
                    function() {
                        ...
                        var newURL = '{{ url('/purchase/order') }}';
                        var newState = {
                            page: 'index-purchase-order'
                        };
                        var newTitle = '{{ __('messages.purchaseorder') }}';

                        window.history.pushState(newState, newTitle, newURL);

                        $.ajax({
                            url: '{{ url('/purchase/order/fetchdb') }}' + "/" + xpp + "/" + xisactive + "/" +
