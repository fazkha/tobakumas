<div class="my-2">
    <div class="flex flex-col-reverse md:flex-row gap-4 justify-between">
            ...
            <div class="flex flex-col lg:flex-row justify-start">
                <div class="flex-row justify-start">
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="pp-dropdown"
                            ...
                            <option {{ session('supplier_pp') == 12 ? 'selected' : '' }} value="12">12</option>
                            <option {{ session('supplier_pp') == 24 ? 'selected' : '' }} value="24">24</option>
                            <option {{ session('supplier_pp') == 36 ? 'selected' : '' }} value="36">36</option>
                        </select>
                        <div
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="isactive-dropdown"
                            class="text-sm px-2 leading-tight pl-28 pr-9 py-2 appearance-none w-full h-full rounded-md border block bg-primary-20 border-primary-100 text-gray-700 dark:text-white dark:bg-primary-700 dark:border-primary-800">
                            <option {{ session('supplier_isactive') == 'all' ? 'selected' : '' }} value="all">
                                @lang('messages.all')</option>
                            <option {{ session('supplier_isactive') == '1' ? 'selected' : '' }} value="1">
                                @lang('messages.yes')</option>
                            <option {{ session('supplier_isactive') == '0' ? 'selected' : '' }} value="0">
                ...
                <div class="flex-row justify-start">
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <input id="search-kode" placeholder="{{ __('messages.search') }}"
                            value="{{ session('supplier_kode') == '_' ? '' : session('supplier_kode') }}"
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <input id="search-nama" placeholder="{{ __('messages.search') }}"
                            value="{{ session('supplier_nama') == '_' ? '' : session('supplier_nama') }}"
                            class="text-sm pl-28 pr-6 pt-1.5 pb-2 appearance-none rounded-md border block w-full bg-primary-20 border-primary-100 placeholder-gray-400 text-gray-700 dark:text-white dark:bg-primary-700 dark:border-primary-800" />
                    </div>
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <input id="search-alamat" placeholder="{{ __('messages.search') }}"
                            value="{{ session('supplier_alamat') == '_' ? '' : session('supplier_alamat') }}"
                            class="text-sm pl-28 pr-6 pt-1.5 pb-2 appearance-none rounded-md border block w-full bg-primary-20 border-primary-100 placeholder-gray-400 text-gray-700 dark:text-white dark:bg-primary-700 dark:border-primary-800" />
                    </div>
        ...
        <div>
            @can('supplier-create')
                <x-anchor-primary href="{{ route('supplier.create') }}">
