<div class="my-2">
    <div class="flex flex-col-reverse md:flex-row gap-4 justify-between">
                ...
                <div class="flex-row justify-start">
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="pp-dropdown"
                            ...
                            <option {{ session('gudang_pp') == 15 ? 'selected' : '' }} value="15">15</option>
                            <option {{ session('gudang_pp') == 30 ? 'selected' : '' }} value="30">30</option>
                            <option {{ session('gudang_pp') == 45 ? 'selected' : '' }} value="45">45</option>
                        </select>
                        <div
                    ...
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="isactive-dropdown"
                            ...
                            <option {{ session('gudang_isactive') == '0' ? 'selected' : '' }} value="0">
        ...
        <div>
            @can('gudang-create')
                <x-anchor-primary href="{{ route('gudang.create') }}">
