        ...
        <table class="min-w-full leading-normal">
            <thead>
                <tr>
                    ...
                    <th
                        class="w-1/4 px-3 py-3 text-left text-xs font-semibold uppercase tracking-wider border-b border-primary-100 text-gray-600 bg-primary-50 dark:text-white dark:bg-primary-800 dark:border-primary-800">
            ...
            <tbody>
                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->kode }}</span>
                        </td>
                        <td
                            class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                        ...
                        <td
                            class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->alamat }}</span>
                        </td>
                        <td
                            class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->kontak_telpon }}</span>
                        </td>
                        <td
                            class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->kontak_nama }}</span>
                        </td>
                        <td
                            class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                        ...
                        <td class="px-3 py-3 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800"
                            ...
                            <div class="flex items-center justify-center">
                                @can('customer-show')
                                    <a href="{{ route('customer.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('customer-edit')
                                    <a href="{{ route('customer.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('customer-delete')
                                    <a href="{{ route('customer.delete', Crypt::Encrypt($data->id)) }}"
