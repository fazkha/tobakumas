...
S254.158,299.966,218.317,299.966z" />
    ...
    <form action="{{ route('brandivjabkec.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                                            ...
                                            <div class="p-2 flex flex-col gap-2">
                                                @foreach ($kecamatans as $kecamatan)
                                                    ...
                                                    @if ($kab !== $kecamatan->namakabupaten)
                                                        ...
                                                        @endphp
                                                        <span
                                                            class="font-bold px-8">{{ $kecamatan->namakabupaten }}</span>
                                                    @endif
                                                    <span class="px-16">
