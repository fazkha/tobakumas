...
S254.158,299.966,218.317,299.966z" />
    ...
    <div class="mx-auto px-4 py-2">
        <div class="flex flex-col items-center">
            ...
            <div class="w-full">
                @include('brandivjabkec.partials.filter')
            </div>

            <div id="table-container" class="w-full">
                @include('brandivjabkec.partials.table')
            </div>
        ...
        <script type="text/javascript">
            $("#pp-dropdown, #isactive-dropdown, #propinsi-dropdown, #kabupaten-dropdown").on(
                ...
                function() {
                    ...
                    var newURL = '{{ url('/marketing/brandivjabkec') }}';
                    var newState = {
                    ...
                    $.ajax({
                        url: '{{ url('/marketing/brandivjabkec/fetchdb') }}' + "/" + xpp + "/" + xisactive + "/" +
                            xprop + "/" + xkab,
                        type: "GET",
                        dataType: 'json',
