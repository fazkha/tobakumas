                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            @php
                                $wilayahs = Brandivjabkec::where('brandivjab_id', $data->brandivjab_id)
                            ...
                            <div class="flex flex-col flex-wrap lg:flex-row gap-2 text-gray-900 dark:text-white">
                                @foreach ($wilayahs as $wilayah)
                                    <div
                                        ...
                                        <span>&bull;</span><span class="pl-2">{{ $wilayah->kecamatan->nama }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </td>
                        ...
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800"
                            ...
                            <div class="flex items-center justify-center">
                                @can('kabupaten-show')
                                    <a href="{{ route('brandivjabkec.show', Crypt::Encrypt($data->brandivjab_id)) }}"
                                ...
                                @can('kabupaten-edit')
                                    <a href="{{ route('brandivjabkec.edit', Crypt::Encrypt($data->brandivjab_id)) }}"
                                ...
                                @can('forbidden-delete')
                                    <a href="{{ route('brandivjabkec.delete', Crypt::Encrypt($data->brandivjab_id)) }}"
