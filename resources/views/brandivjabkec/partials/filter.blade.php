                ...
                <div class="flex-row justify-start">
                    <div class="relative shadow-md mr-2 mb-2">
                        ...
                        <select id="pp-dropdown"
                            ...
                            <option {{ session('brandivjabkec_pp') == 12 ? 'selected' : '' }} value="12">12</option>
                            <option {{ session('brandivjabkec_pp') == 24 ? 'selected' : '' }} value="24">24</option>
                            <option {{ session('brandivjabkec_pp') == 36 ? 'selected' : '' }} value="36">36</option>
                        </select>
                        <div
