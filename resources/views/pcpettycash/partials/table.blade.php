            ...
            <tbody>
                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->cabang->nama }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->nominal }}</span>
                        </td>
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800"
                            ...
                            <div class="flex items-center justify-center">
                                @can('pcpettycash-show')
                                    <a href="{{ route('pcpettycash.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('pcpettycash-edit')
                                    <a href="{{ route('pcpettycash.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('pcpettycash-delete')
                                    <a href="{{ route('pcpettycash.delete', Crypt::Encrypt($data->id)) }}"
