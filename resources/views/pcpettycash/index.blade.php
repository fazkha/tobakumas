    ...
    <div class="mx-auto px-4 py-2">
        <div class="flex flex-col items-center">
            ...
            <div id="table-container" class="w-full">
                @include('pcpettycash.partials.table')
            </div>
        ...
        <script type="text/javascript">
            $("#pp-dropdown, #branch-dropdown, #search-tanggal").on(
                ...
                function() {
                    ...
                    var newURL = '{{ url('/finance/pcpettycash') }}';
                    var newState = {
                        page: 'index-pcpettycash'
                    };
                    var newTitle = '{{ __('messages.pcpettycash') }}';

                    window.history.pushState(newState, newTitle, newURL);

                    $.ajax({
                        url: '{{ url('/finance/pcpettycash/fetchdb') }}' + "/" + xpp + "/" + xbr + "/" + xtanggal,
                        type: "GET",
                        dataType: 'json',
