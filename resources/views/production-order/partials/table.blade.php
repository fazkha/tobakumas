                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span
                                class="text-gray-900 dark:text-white">{{ $data->order ? $data->order->no_order : '-' }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span
                        ...
                        <td
                            ...
                            <span
                                class="text-gray-900 dark:text-white">{{ $data->order ? ($data->order->isready == 1 ? '✔️' : '❌') : '-' }}</span>
                        </td>
                            ...
                            <div class="flex items-center justify-center">
                                @can('prodo-show')
                                    <x-anchor-transparent id="print_one-anchor-{{ $data->id }}"
                                        onclick="print_one({{ $data->id }})"
                                        title="{{ __('messages.productionreport') }}" class="ml-2">
                                        <span
                                    ...
                                    <svg id="print_one-icon-{{ $data->id }}" class="hidden size-5 mx-3"
