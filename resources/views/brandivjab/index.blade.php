    ...
    <div class="mx-auto px-4 py-2">
        <div class="flex flex-col items-center">
            ...
            <div id="table-container" class="w-full">
                @include('brandivjab.partials.table')
            </div>
        ...
        <script type="text/javascript">
            $("#pp-dropdown, #isactive-dropdown, #branch-dropdown, #division-dropdown, #jabatan-dropdown").on(
                ...
                function() {
                    ...
                    var newURL = '{{ url('/general-affair/brandivjab') }}';
                    var newState = {
                        page: 'index-brandivjab'
                    };
                    var newTitle = '{{ __('messages.brandivjab') }}';

                    window.history.pushState(newState, newTitle, newURL);

                    $.ajax({
                        url: '{{ url('/general-affair/brandivjab/fetchdb') }}' + "/" + xpp + "/" + xisactive + "/" +
                            xbr + "/" + xdv + "/" + xjb,
                        type: "GET",
                        dataType: 'json',
