                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span
                                class="text-gray-900 dark:text-white">{{ $data->division_id ? $data->division->nama : '-' }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->jabatan->nama }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                        ...
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800"
                            ...
                            <div class="flex items-center justify-center">
                                @can('brandivjab-show')
                                    <a href="{{ route('brandivjab.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('brandivjab-edit')
                                    <a href="{{ route('brandivjab.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('brandivjab-delete')
                                    <a href="{{ route('brandivjab.delete', Crypt::Encrypt($data->id)) }}"
