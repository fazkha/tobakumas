            ...
            <tbody>
                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->propinsi->nama }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span class="text-gray-900 dark:text-white">{{ $data->kabupaten->nama }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                        ...
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800"
                            ...
                            <div class="flex items-center justify-center">
                                @can('kabupaten-show')
                                    <a href="{{ route('kecamatan.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('kabupaten-edit')
                                    <a href="{{ route('kecamatan.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('kabupaten-delete')
                                    <a href="{{ route('kecamatan.delete', Crypt::Encrypt($data->id)) }}"
