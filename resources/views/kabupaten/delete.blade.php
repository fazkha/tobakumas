    ...
    <div class="flex items-center justify-between px-4 py-4 border-b border-primary-100 lg:py-6 dark:border-primary-800">
        <h1 class="text-xl flex items-center justify-center">
            <a href="{{ route('kabupaten.index') }}" class="flex items-center justify-center">
                ...
                <span class="px-2">@lang('messages.kabupaten')</span>
            </a>
        ...
        <div class="container mx-auto px-2 sm:px-4 py-2">
            <div class="flex flex-col items-center">
                ...
                <div class="w-3/4 lg:w-1/2 shadow mb-5" role="alert">
                    <form action="{{ route('kabupaten.destroy', Crypt::Encrypt($datas->id)) }}" class="block"
                            ...
                            <div class="bg-white border-r-4 border-red-600 w-full p-4">
                                <div>
                                    ...
                                    <div class="flex flex-col md:flex-row gap-2 justify-between">
                                        ...
                                        <x-anchor-secondary href="{{ route('kabupaten.index') }}" tabindex="1"
                                            autofocus>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="size-5">
                                                <path stroke-linecap="round" stroke-linejoin="round"
