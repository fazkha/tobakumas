                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                            <span
                                class="text-gray-900 dark:text-white">{{ $bulans[$data->periode_bulan] . ' ' . $data->periode_tahun }}</span>
                        </td>
                        <td
                            class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800">
                        ...
                        <td class="px-3 py-1 text-sm border-b border-primary-100 bg-primary-20 dark:bg-primary-900 dark:border-primary-800"
                            ...
                            <div class="flex items-center justify-center">
                                @can('po-show')
                                    <a href="{{ route('purchase-plan.show', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('po-edit')
                                    <a href="{{ route('purchase-plan.edit', Crypt::Encrypt($data->id)) }}"
                                ...
                                @can('po-delete')
                                    <a href="{{ route('purchase-plan.delete', Crypt::Encrypt($data->id)) }}"
