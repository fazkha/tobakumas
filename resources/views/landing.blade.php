...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="absolute top-0 left-0 w-full max-w-2xl px-6 lg:max-w-7xl">
            ...
            <footer class="absolute bottom-0 left-0 py-16 text-center text-sm text-black dark:text-white/70">
                <div>&copy; Copyright 2025 {{ config('custom.company_name') }}. All rights reserved.</div>
